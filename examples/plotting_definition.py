...
def plotting_definition_template(df):
    ...
    decision_makers.append(DecisionMaker(name_pattern="resnet50m",
                           color=rgb(65, 90, 140), marker="o", df=df,
                           plotting_name="ResNet-50M"))

    decision_makers.append(DecisionMaker(name_pattern="resnet50d",
                           color=rgb(110, 110, 110), marker="o", df=df,
                           plotting_name="ResNet-50D"))

    decision_makers.append(DecisionMaker(name_pattern="resnet50s",
                           color=rgb(210, 150, 0), marker="o", df=df,
                           plotting_name="ResNet-50S"))

    decision_makers.append(DecisionMaker(name_pattern="resnet50t",
                           color=rgb(210, 0, 150), marker="o", df=df,
                           plotting_name="ResNet-50T"))
